...
void map_test()
{
  ...
  con::hash_map<con::string, con::string> hash_map;
  hash_map.push(con::pair(con::string("泥嚎世界"), con::string("hello,world!")));
  std::cout << hash_map.find(con::pair(con::string("泥嚎世界"), con::string("hello,world!")))->second << std::endl;
  hash_map.push(con::pair(con::string("值"), con::string("value")));
  std::cout << hash_map.find(con::pair(con::string("值"), con::string("hello,world!")))->second << std::endl;
  for(auto &i : hash_map)
  {
