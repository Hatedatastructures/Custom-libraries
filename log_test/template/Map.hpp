...
namespace map_container
{
    ...
    typename first_external_hash_functions = con::imitation_functions::hash_imitation_functions,
    typename second_external_hash_functions = con::imitation_functions::hash_imitation_functions> //两个对应的hash函数
    class hash_map
    {
